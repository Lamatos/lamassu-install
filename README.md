...
This will install your [**Lamassu Admin**](https://lamassu.is/admin) and server on a DigitalOcean droplet running Ubuntu Server 24.04 LTS.
...
```
curl -O https://raw.githubusercontent.com/lamassu/lamassu-install/release-11/install && bash install
```
...
```
curl -sS https://raw.githubusercontent.com/lamassu/lamassu-install/release-11/upgrade-ls | bash
```
