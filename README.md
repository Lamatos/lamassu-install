...
```
curl -O https://raw.githubusercontent.com/lamassu/lamassu-install/release-12/install && bash install
```
...
```
curl -sS https://raw.githubusercontent.com/lamassu/lamassu-install/release-12/upgrade-ls | bash
```
